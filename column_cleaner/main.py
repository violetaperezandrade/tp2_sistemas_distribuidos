...
def initialize_config():
    ...
    try:
        ...
        config_params["output_exchanges"] = config["DEFAULT"]["OUTPUT_EXCHANGES"].split(",")
...
def main():
    ...
    output_exchanges = config_params["output_exchanges"]
    ...
    cleaner = ColumnCleaner(output_queue, output_exchanges, required_columns_flights,
                            required_columns_airports, ack_necessary)
    connection = connect_mom()
    print(f"input_exchange")
